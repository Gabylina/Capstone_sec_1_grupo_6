  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setAlertType("error")
        setAlertTitle("Error")
        const errorMsg = processApiErrorMessage(response.message, 'No se pudieron cargar los datos del Excel. Por favor verifica el archivo e intenta nuevamente.')
      ...
      setAlertType("error")
      setAlertTitle("Error")
      const errorMsg = processApiErrorMessage(error.message, 'No se pudo procesar el archivo Excel. Por favor verifica el formato del archivo e intenta nuevamente.')
      setAlertDescription(errorMsg)
      setAlertOpen(true)
    } finally {
