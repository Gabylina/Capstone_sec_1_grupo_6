...
import clientePortalRoutes from '@/routes/clientePortal';
...
import satisfaccionClienteRoutes from '@/routes/satisfaccionCliente';
...
app.use('/api/satisfaccion-cliente', satisfaccionClienteRoutes);
